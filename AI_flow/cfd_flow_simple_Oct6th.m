...
l = 1;
 ...
 for k = 0:7
     for j = 1:3
        ...
        dlmwrite(['./',filename,'/',filename,'_x.csv'],[], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_y.csv'],[], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_z.csv'],[], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_v_x.csv'], [], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_v_y.csv'], [], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_v_z.csv'], [], 'delimiter', ',');
%       dlmwrite(['./',p.filename,'/',p.filename,'_MSD.csv'], [], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_v.csv'], [], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_theta.csv'], [], 'delimiter', ',');
        dlmwrite(['./',filename,'/',filename,'_phi.csv'], [], 'delimiter', ',');
...
%         dlmwrite(['./',p.filename,'/',p.filename,'_Tz.csv'], [], 'delimiter', ',');
        ...
        %     end
            ...
            dlmwrite(['./',filename,'/',filename,'_x.csv'], x_cell.location_x','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_y.csv'], x_cell.location_y','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_z.csv'], x_cell.location_z','delimiter',',','-append');
%             
% %             dlmwrite(['./',p.filename,'/',p.filename,'_T.csv'], sqrt(F.traction(:,1).^2+F.traction(:,2).^2+F.traction(:,3).^2)'*1e12,'delimiter',',','-append');
% 
            dlmwrite(['./',filename,'/',filename,'_v_x.csv'], x_cell.v(:,1)','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_v_y.csv'], x_cell.v(:,2)','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_v_z.csv'], x_cell.v(:,3)','delimiter',',','-append');
% 
% %             dlmwrite(['./',p.filename,'/',p.filename,'_MSD.csv'], MSD','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_v.csv'], 3600*speed_magnitude','delimiter',',','-append'); 
            dlmwrite(['./',filename,'/',filename,'_theta.csv'],cell_theta','delimiter',',','-append');
            dlmwrite(['./',filename,'/',filename,'_phi.csv'],cell_phi','delimiter',',','-append');
