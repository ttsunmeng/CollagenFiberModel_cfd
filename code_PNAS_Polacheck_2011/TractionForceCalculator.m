...
for i = 1:x_cell.N
   ...
   if p.flow_v_z == 0.3
       F.traction(i,:) = F.traction(i,:) + p.ctraction*p.E*p.ctraction_v1*[sum(list_x_direction(list_z_direction < 0)) sum(list_y_direction(list_z_direction < 0)) sum(list_z_direction(list_z_direction < 0))];
   elseif p.flow_v_z == 3
       F.traction(i,:) = F.traction(i,:) + p.ctraction*p.E*p.ctraction_v2*[sum(list_x_direction(list_z_direction < 0)) sum(list_y_direction(list_z_direction < 0)) sum(list_z_direction(list_z_direction < 0))];
   end
