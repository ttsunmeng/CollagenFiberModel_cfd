...
x_cell.location_x = mod(x_cell.location_x - p.bottom_scale_x - 20,p.domain_scale_x - 40) + p.bottom_scale + 20;
x_cell.location_y = mod(x_cell.location_y - p.bottom_scale_y - 20,p.domain_scale_y - 40) + p.bottom_scale + 20;
if abs(x_cell.location_z) > 
